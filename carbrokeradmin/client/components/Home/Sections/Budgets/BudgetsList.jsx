...
import { BudgetIndex } from '../../../../../collections/Budget';

import GeneralStyles from './BudgetsStyles';
import BudgetsForm from './BudgetsForm/BudgetsForm';
...
class BudgetsList extends Component {
    ...
    renderModal() {
        if (this.state.openModal) {
            return(
                <BudgetsForm
                    budget={this.state.selectedModel}
...
BudgetsList.propTypes = propTypes;

export default createContainer(() => {
    return {
        data: Budget.find().fetch()
    };
}, BudgetsList);
